...
import com.rx.rxmvvmlib.repository.config.AppConfig;
...
public class RMEngine {
    private static volatile RMEngine rxMVVMInit;
    public static AppConfig config;

    public static RMEngine getInstance() {
        if (rxMVVMInit == null) {
            synchronized (RMEngine.class) {
                if (rxMVVMInit == null) {
                    rxMVVMInit = new RMEngine();
                }
            }
        }
        return rxMVVMInit;
