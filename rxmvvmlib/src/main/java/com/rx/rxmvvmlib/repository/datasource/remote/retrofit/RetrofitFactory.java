...
public class RetrofitFactory {
    ...
    static {
        try {
            url = RMEngine.getConfig().getHttpBaseUrl();
            ...
            OkHttpClient.Builder builder = new OkHttpClient.Builder()
                    ...
                    .cache(cache);
            if (RMEngine.getConfig().getInterceptors() != null
                    && RMEngine.getConfig().getInterceptors().size() > 0) {
                for (Interceptor interceptor : RMEngine.getConfig().getInterceptors()) {
